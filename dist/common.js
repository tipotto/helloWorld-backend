...
exports.onFetchSupportedLangs = exports.onTranslateTexts = void 0;
const functions = require("firebase-functions");
const translate_1 = require("./api/translate");
exports.onTranslateTexts = functions
    .runWith({
    timeoutSeconds: 240,
    memory: '1GB',
})
    ...
    if (!(context.auth && context.auth.uid)) {
        throw new functions.https.HttpsError('permission-denied', 'Must be an authenticated user to translate texts.');
    }
    const transTexts = data.transTexts;
    const transLang = data.transLang;
    return translate_1.default.shared.translate(transTexts, transLang);
});
exports.onFetchSupportedLangs = functions
    .runWith({
    timeoutSeconds: 240,
    memory: '1GB',
})
    ...
    return translate_1.default.shared.fetchSupportedLangs(userLang);
});
